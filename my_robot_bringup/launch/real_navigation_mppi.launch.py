...
def generate_launch_description():
    ...
    configured_nav2_params = RewrittenYaml(
        ...
        root_key='',
        param_rewrites={
            'default_nav_to_pose_bt_xml': forward_only_nav_bt,
        },
        convert_types=True,
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('cmd_vel_max_linear_x', default_value='0.24'),
        DeclareLaunchArgument('cmd_vel_max_linear_y', default_value='0.18'),
        DeclareLaunchArgument('cmd_vel_max_angular_z', default_value='0.60'),

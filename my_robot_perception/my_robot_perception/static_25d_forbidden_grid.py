...
class Static25DForbiddenGrid(Node):
    def __init__(self):
        ...
        description_share_dir = get_package_share_directory('my_robot_description')
        navigation_share_dir = get_package_share_directory('my_robot_navigation')
        self.declare_parameter(
            'world_file', os.path.join(description_share_dir, 'worlds', 'door_world.sdf'))
        self.declare_parameter(
            'urdf_file', os.path.join(description_share_dir, 'urdf', 'mobile_manipulator.urdf'))
        self.declare_parameter(
            'config_file', os.path.join(navigation_share_dir, 'config', 'safety_shell.yaml'))

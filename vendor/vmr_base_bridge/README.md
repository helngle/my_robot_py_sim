...
`vmr_nav.launch.py` 额外启动静态地图发布节点，用于在 RViz 显示栅格地图和 costmap。默认地图参数为：

```bash
map_yaml:=/home/zfb/semantic_map_ws/maps/Test051201/Test051201.yaml
```

需要切换地图时可覆盖：

```bash
ros2 launch /home/zfb/semantic_map_ws/launch/vmr_nav.launch.py \

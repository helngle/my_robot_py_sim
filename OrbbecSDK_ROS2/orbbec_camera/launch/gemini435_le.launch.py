...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument('publish_timestamp_offset_us', default_value='00000'),
        ...
        DeclareLaunchArgument('preset_resolution_config', default_value='640, 400, 1, 1'),
        DeclareLaunchArgument('retry_on_usb3_detection_failure', default_value='false'),
        DeclareLaunchArgument('laser_energy_level', default_value='-1'),
        DeclareLaunchArgument('enable_sync_host_time', default_value='true'),
        DeclareLaunchArgument('time_sync_period', default_value='60.0'), # seconds
        DeclareLaunchArgument('time_domain', default_value='system'),# global, device, system
        DeclareLaunchArgument('sync_color_depth_timestamp', default_value='true'),
        ...
        # full_frame=凑齐 depth+color 再输出，保证同一次采集；ANY=有帧就出，可能不同步
        DeclareLaunchArgument('frame_aggregate_mode', default_value='full_frame'),  # full_frame, color_frame, ANY, disable
        ...
        DeclareLaunchArgument("force_ip_address", default_value="192.168.31.190"),  # Static IP address to assign
        DeclareLaunchArgument("force_ip_subnet_mask", default_value="255.255.255.0"),  # Subnet mask used for static IP
        DeclareLaunchArgument("force_ip_gateway", default_value="192.168.31.1"),  # Gateway address used for static IP

...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/launch', [
            ...
            'launch/navigation_25d_with_rviz.launch.py',
            'launch/real_base_test.launch.py',
            'launch/real_navigation_with_rviz.launch.py',
            'launch/real_navigation_no_odom_with_rviz.launch.py',
            'launch/real_navigation_no_odom_omni_with_rviz.launch.py',
            'launch/real_navigation_no_odom_mppi_with_rviz.launch.py',
        ]),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'static_25d_forbidden_grid = my_robot_py_sim.static_25d_forbidden_grid:main',
            ...
            'route_insert_editor = my_robot_py_sim.route_insert_editor:main',
